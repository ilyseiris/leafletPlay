var map = L.map ('map').setView([37.766813, -122.41692], 12);
...
ZOOM0080.bindPopup("I came to Fort mason every day over the course of a four day weekend to compete in the Magic the Gathering World Championships.").openPopup();